...
const file_alis_ideate_ideate_proto_rawDesc = "" +
	"\n" +
	"\x18alis/ideate/ideate.proto\x12\valis.ideate\x1a google/protobuf/field_mask.proto\x1a#google/longrunning/operations.proto\x1a\x1calis/ideate/agent_card.proto\x1a\x16alis/ideate/idea.proto\x1a\x16alis/ideate/spec.proto\x1a\x18alis/ideate/stream.proto\"\xe7\x01\n" +
	"\x0eAddNoteRequest\x12\x1a\n" +
	"\aaccount\x18\x01 \x01(\tH\x00R\aaccount\x12\x14\n" +
	"\x04idea\x18\x02 \x01(\tH\x00R\x04idea\x12\x1a\n" +
	"\x05token\x18\x03 \x01(\tB\x02\x18\x01H\x00R\x05token\x123\n" +
	"\x14contribution_session\x18\x04 \x01(\tH\x00R\x13contributionSession\x12'\n" +
	"\x0ecollection_key\x18\x06 \x01(\tH\x00R\rcollectionKey\x12\x18\n" +
	"\acontent\x18\x05 \x01(\tR\acontentB\x0f\n" +
	"\rstream_target\">\n" +
	"\x0fAddNoteResponse\x12+\n" +
	"\x06stream\x18\x01 \x01(\v2\x13.alis.ideate.StreamR\x06stream\"\xaf\x02\n" +
	"\x13AddAudioNoteRequest\x12\x1a\n" +
	"\aaccount\x18\x01 \x01(\tH\x00R\aaccount\x12\x14\n" +
	"\x04idea\x18\x02 \x01(\tH\x00R\x04idea\x12\x1a\n" +
	"\x05token\x18\x03 \x01(\tB\x02\x18\x01H\x00R\x05token\x123\n" +
	"\x14contribution_session\x18\x04 \x01(\tH\x00R\x13contributionSession\x12'\n" +
	"\x0ecollection_key\x18\b \x01(\tH\x00R\rcollectionKey\x12\x1b\n" +
	...
	"\n" +
	"upload_uri\x18\x02 \x01(\tR\tuploadUri\"\xb0\x03\n" +
	"\x19AddMultiFileUploadRequest\x12\x1a\n" +
	"\aaccount\x18\x01 \x01(\tH\x00R\aaccount\x12\x14\n" +
	"\x04idea\x18\x02 \x01(\tH\x00R\x04idea\x12\x1a\n" +
	"\x05token\x18\x03 \x01(\tB\x02\x18\x01H\x00R\x05token\x123\n" +
	"\x14contribution_session\x18\x04 \x01(\tH\x00R\x13contributionSession\x12'\n" +
	"\x0ecollection_key\x18\b \x01(\tH\x00R\rcollectionKey\x12\x12\n" +
	...
	"\n" +
	"upload_uri\x18\x03 \x01(\tR\tuploadUri\"\xc4\x02\n" +
	...
	"\aaccount\x18\x01 \x01(\tH\x00R\aaccount\x12\x14\n" +
	"\x04idea\x18\x02 \x01(\tH\x00R\x04idea\x12\x1a\n" +
	"\x05token\x18\x03 \x01(\tB\x02\x18\x01H\x00R\x05token\x12'\n" +
	"\x0ecollection_key\x18\x04 \x01(\tH\x00R\rcollectionKey\x12i\n" +
